...
Vamos supor que nosso programa requeira um armazenamento em vetor que
esteja submetido às seguintes regras:

- O armazenamento é numérico do tipo int.
- Há um valor mínimo e um valor máximo suportados no vetor.
- Há um valor (fora do intervalo mínimo → máximo) que será armazenado nas posições vagas.
